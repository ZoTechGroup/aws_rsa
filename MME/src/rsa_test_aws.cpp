...
int main(int argc, char *argv[])
{
    ...
    if ( hw_emulation ) 
      {
        kernel_file = "./xclbin/rsa_hls_krnl.hw_emu.xilinx_aws-vu9p-f1-04261818_dynamic_5_0.xclbin";
      }
    else if ( sw_emulation ) 
      {
        kernel_file = "./xclbin/rsa_hls_krnl.sw_emu.xilinx_aws-vu9p-f1-04261818_dynamic_5_0.xclbin";
      }
    else 
      {
        kernel_file = "/opt/xclbin/rsa_hls_krnl.hw.xilinx_aws-vu9p-f1-04261818_dynamic_5_0.awsxclbin";
      }

    opencl_init("xilinx_aws-vu9p-f1-04261818_dynamic_5_0", kernel_file);
